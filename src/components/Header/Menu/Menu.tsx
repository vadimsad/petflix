					...
					<NavLink
						...
						className={({ isActive }) =>
							isActive
								...
								: 'after:absolute after:content-[""] after:w-0 after:h-[2px] after:bg-light after:bottom-0 after:left-1/2 after:-translate-x-1/2 hover:after:w-1/2 active:after:w-full after:transition-[width]'
						}
					>
						Главная
					</NavLink>
