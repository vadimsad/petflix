...
const QuickResult = React.memo(({ shown }) => {
	...
	return (
		<ul
			...
			} absolute z-20 right-0 md:w-[30vw] xsm:w-[300px] w-full h-[500px] py-2 rounded-xl overflow-auto border-2 border-dark dark:border-blue bg-light dark:bg-dark transition-[opacity_0.3s_ease]`}
		>
			{isLoading ? (
